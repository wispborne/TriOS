...
class _SummarySection extends StatelessWidget {
  ...
  const _SummarySection({required this.text, required this.source});

  static String _noteFor(ModSummarySource source) => switch (source) {
    ModSummarySource.modIndex => 'Summary from Discord.',
