...
class ChipperLog extends ConsumerStatefulWidget {
  ...
  const ChipperLog({super.key, required this.errors, required this.showInfoLogs});
                          ...
                          Container(
                              ...
                              child: IntrinsicHeight(
                                ...
                                Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                                  Row(children: [
                                    if (!isConsecutiveWithPreviousLine(index, showInfoLogs))
                                      ViewPreviousEntryButton(errors: errors, theme: theme, index: index)
                                    else
                                      Container(
                                        width: 20,
                                      ),
                                ...
                                Expanded(child: errors[index].createLogWidget(context))
                              ])))
                        ]);
                })));
  }
