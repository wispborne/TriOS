      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Text(
                "VRAM is Video RAM. It's memory physically located on the graphics card, and cannot be upgraded without a new graphics card."),
            const SizedBox(height: 8),
            Text(
                "Unlike RAM, VRAM cannot be manually assigned, and the game will use as much as it needs."),
            const SizedBox(height: 8),
            Text(
