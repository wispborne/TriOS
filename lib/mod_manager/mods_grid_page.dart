...
class _ModsGridState extends ConsumerState<ModsGridPage>
              ...
              child: Padding(
                ...
                child: WispGrid<Mod>(
                  ...
                  preSortComparator: (left, right) {
                    final leftMetadata =
                        modsMetadata?.getMergedModMetadata(left.id);
                    final rightMetadata =
                        modsMetadata?.getMergedModMetadata(right.id);
                  ...
                  columns: [
                    ...
                    WispGridColumn<Mod>(
                      ...
                      defaultState:
                          WispGridColumnState(position: 4, width: 200),
                    ),
                    WispGridColumn<Mod>(
                      ...
                      defaultState:
                          WispGridColumnState(position: 5, width: 200),
                    ),
                    WispGridColumn<Mod>(
                      ...
                      defaultState:
                          WispGridColumnState(position: 6, width: 100),
                    ),
                    WispGridColumn<Mod>(
                      ...
                      defaultState:
                          WispGridColumnState(position: 7, width: 110),
                    ),
                    WispGridColumn<Mod>(
                      ...
                      defaultState:
                          WispGridColumnState(position: 8, width: 100),
                    ),
                    WispGridColumn<Mod>(
                      ...
                      itemCellBuilder: (mod, modifiers) => Opacity(
                        opacity: WispGrid.lightTextOpacity,
                        child: Text(
                            modsMetadata?.getMergedModMetadata(mod.id)?.let(
                      ...
                      defaultState:
                          WispGridColumnState(position: 9, width: 150),
                    ),
                    WispGridColumn<Mod>(
  ...
  Builder buildVramCell(
      double lightTextOpacity, Mod mod, WispGridColumnState state) {
    return Builder(builder: (context) {
      ...
      return Expanded(
        child: Builder(builder: (context) {
          final vramEstimatorState = ref.watch(AppState.vramEstimatorProvider);
          ...
          final biggestFish = vramMap
              .maxBy(
                  (e) => e.value.bytesUsingGraphicsLibConfig(graphicsLibConfig))
              ?.value
