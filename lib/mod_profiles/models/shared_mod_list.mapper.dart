...
mixin SharedModListMappable {
  String toJson() {
    return SharedModListMapper.ensureInitialized()
        .encodeJson<SharedModList>(this as SharedModList);
  }

  Map<String, dynamic> toMap() {
    return SharedModListMapper.ensureInitialized()
        .encodeMap<SharedModList>(this as SharedModList);
  }
  ...
  SharedModListCopyWith<SharedModList, SharedModList, SharedModList>
      get copyWith => _SharedModListCopyWithImpl<SharedModList, SharedModList>(
          this as SharedModList, $identity, $identity);
  @override
  String toString() {
    return SharedModListMapper.ensureInitialized()
        .stringifyValue(this as SharedModList);
  }

  @override
  bool operator ==(Object other) {
    return SharedModListMapper.ensureInitialized()
        .equalsValue(this as SharedModList, other);
  }

  @override
  int get hashCode {
    return SharedModListMapper.ensureInitialized()
        .hashValue(this as SharedModList);
  }
}
...
abstract class SharedModListCopyWith<$R, $In extends SharedModList, $Out>
  ...
  ListCopyWith<$R, SharedModVariant,
...
class SharedModVariantMapper extends ClassMapperBase<SharedModVariant> {
  ...
  static const Field<SharedModVariant, String> _f$modId =
      Field('modId', _$modId);
  static String? _$modName(SharedModVariant v) => v.modName;
  static const Field<SharedModVariant, String> _f$modName =
      Field('modName', _$modName, opt: true);
  static String _$smolVariantId(SharedModVariant v) => v.smolVariantId;
  static const Field<SharedModVariant, String> _f$smolVariantId =
      Field('smolVariantId', _$smolVariantId, key: r'variantId');
  static Version? _$versionName(SharedModVariant v) => v.versionName;
  static const Field<SharedModVariant, Version> _f$versionName =
      Field('versionName', _$versionName, opt: true, hook: VersionHook());
  ...
  SharedModVariantCopyWith<SharedModVariant, SharedModVariant, SharedModVariant>
      get copyWith =>
          _SharedModVariantCopyWithImpl<SharedModVariant, SharedModVariant>(
              this as SharedModVariant, $identity, $identity);
  @override
  String toString() {
    return SharedModVariantMapper.ensureInitialized()
        .stringifyValue(this as SharedModVariant);
  }

  @override
  bool operator ==(Object other) {
    return SharedModVariantMapper.ensureInitialized()
        .equalsValue(this as SharedModVariant, other);
  }

  @override
  int get hashCode {
    return SharedModVariantMapper.ensureInitialized()
        .hashValue(this as SharedModVariant);
  }
}
...
extension SharedModVariantValueCopy<$R, $Out>
  ...
  SharedModVariantCopyWith<$R, SharedModVariant, $Out>
      get $asSharedModVariant => $base
          .as((v, t, t2) => _SharedModVariantCopyWithImpl<$R, $Out>(v, t, t2));
}
