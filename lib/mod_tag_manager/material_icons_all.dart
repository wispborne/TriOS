...
//
// Source: Flutter 3.38.6 icons.dart
// Total base icons: 2146
//
// Every icon here is a `const IconData`. It has to be const: Flutter only
// keeps the icon glyphs it can see written out in the code, and building an
// IconData from a number at runtime switches that off for the whole app,
// which adds tens of megabytes of icon fonts to the build.

import 'package:material_ui/material_ui.dart';

/// Every base Material icon (no _sharp/_rounded/_outlined variants), by name.
