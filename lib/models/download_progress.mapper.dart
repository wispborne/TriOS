...
class TriOSDownloadProgressMapper
  ...
  static const Field<TriOSDownloadProgress, int> _f$bytesReceived = Field(
    'bytesReceived',
    _$bytesReceived,
  );
  static int _$bytesTotal(TriOSDownloadProgress v) => v.bytesTotal;
  static const Field<TriOSDownloadProgress, int> _f$bytesTotal = Field(
    'bytesTotal',
    _$bytesTotal,
  );
  static bool _$isIndeterminate(TriOSDownloadProgress v) => v.isIndeterminate;
  static const Field<TriOSDownloadProgress, bool> _f$isIndeterminate = Field(
    'isIndeterminate',
    _$isIndeterminate,
    opt: true,
    def: false,
  ...
  static const Field<TriOSDownloadProgress, String> _f$customStatus = Field(
    'customStatus',
    _$customStatus,
    opt: true,
  );
  ...
  static TriOSDownloadProgress _instantiate(DecodingData data) {
    return TriOSDownloadProgress(
      data.dec(_f$bytesReceived),
      data.dec(_f$bytesTotal),
...
mixin TriOSDownloadProgressMappable {
  ...
  get copyWith => _TriOSDownloadProgressCopyWithImpl(
    this as TriOSDownloadProgress,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return TriOSDownloadProgressMapper.ensureInitialized().stringifyValue(
      this as TriOSDownloadProgress,
    );
  }
  ...
  bool operator ==(Object other) {
    return TriOSDownloadProgressMapper.ensureInitialized().equalsValue(
      this as TriOSDownloadProgress,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return TriOSDownloadProgressMapper.ensureInitialized().hashValue(
      this as TriOSDownloadProgress,
    );
  }
}
...
class _TriOSDownloadProgressCopyWithImpl<$R, $Out>
  ...
  @override
  TriOSDownloadProgressCopyWith<$R2, TriOSDownloadProgress, $Out2> $chain<
    $R2,
    $Out2
  >(Then<$Out2, $R2> t) => _TriOSDownloadProgressCopyWithImpl($value, $cast, t);
}
