...
class EnabledModsJsonModeMapper extends ClassMapperBase<EnabledModsJsonMode> {
  ...
  static const Field<EnabledModsJsonMode, List<String>> _f$enabledMods = Field(
    'enabledMods',
    _$enabledMods,
  );
...
mixin EnabledModsJsonModeMappable {
  ...
  EnabledModsJsonModeCopyWith<
    EnabledModsJsonMode,
    EnabledModsJsonMode,
    EnabledModsJsonMode
  >
  get copyWith => _EnabledModsJsonModeCopyWithImpl(
    this as EnabledModsJsonMode,
    $identity,
    $identity,
  );
  @override
  String toString() {
    return EnabledModsJsonModeMapper.ensureInitialized().stringifyValue(
      this as EnabledModsJsonMode,
    );
  }
  ...
  bool operator ==(Object other) {
    return EnabledModsJsonModeMapper.ensureInitialized().equalsValue(
      this as EnabledModsJsonMode,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return EnabledModsJsonModeMapper.ensureInitialized().hashValue(
      this as EnabledModsJsonMode,
    );
  }
}
...
abstract class EnabledModsJsonModeCopyWith<
  $R,
  $In extends EnabledModsJsonMode,
  $Out
>
...
class _EnabledModsJsonModeCopyWithImpl<$R, $Out>
  ...
  @override
  EnabledModsJsonModeCopyWith<$R2, EnabledModsJsonMode, $Out2> $chain<
    $R2,
    $Out2
  >(Then<$Out2, $R2> t) => _EnabledModsJsonModeCopyWithImpl($value, $cast, t);
}
...
class ModInfoJsonMapper extends ClassMapperBase<ModInfoJson> {
  ...
  static const Field<ModInfoJson, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static Version? _$version(ModInfoJson v) => v.version;
  static const Field<ModInfoJson, Version> _f$version = Field(
    'version',
    _$version,
    opt: true,
    hook: VersionHook(),
  ...
  static const Field<ModInfoJson, String> _f$author = Field(
    'author',
    _$author,
    opt: true,
  );
  static String? _$gameVersion(ModInfoJson v) => v.gameVersion;
  static const Field<ModInfoJson, String> _f$gameVersion = Field(
    'gameVersion',
    _$gameVersion,
    opt: true,
  );
  static List<Dependency> _$dependencies(ModInfoJson v) => v.dependencies;
  static const Field<ModInfoJson, List<Dependency>> _f$dependencies = Field(
    'dependencies',
    _$dependencies,
    opt: true,
    def: const [],
  ...
  static const Field<ModInfoJson, String> _f$description = Field(
    'description',
    _$description,
    opt: true,
  );
  static String? _$originalGameVersion(ModInfoJson v) => v.originalGameVersion;
  static const Field<ModInfoJson, String> _f$originalGameVersion = Field(
    'originalGameVersion',
    _$originalGameVersion,
    opt: true,
  );
  static bool _$utility(ModInfoJson v) => v.utility;
  static const Field<ModInfoJson, bool> _f$utility = Field(
    'utility',
    _$utility,
    opt: true,
    def: false,
...
mixin ModInfoJsonMappable {
  String toJson() {
    return ModInfoJsonMapper.ensureInitialized().encodeJson<ModInfoJson>(
      this as ModInfoJson,
    );
  }

  Map<String, dynamic> toMap() {
    return ModInfoJsonMapper.ensureInitialized().encodeMap<ModInfoJson>(
      this as ModInfoJson,
    );
  }
  ...
  @override
  String toString() {
    return ModInfoJsonMapper.ensureInitialized().stringifyValue(
      this as ModInfoJson,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return ModInfoJsonMapper.ensureInitialized().equalsValue(
      this as ModInfoJson,
      other,
    );
  }
...
class _ModInfoJsonCopyWithImpl<$R, $Out>
  ...
  ModInfoJson $make(CopyWithData data) => ModInfoJson(
    ...
    originalGameVersion: data.get(
      #originalGameVersion,
      or: $value.originalGameVersion,
    ),
...
class DependencyMapper extends ClassMapperBase<Dependency> {
  ...
  static const Field<Dependency, String> _f$name = Field(
    'name',
    _$name,
    opt: true,
  );
  static Version? _$version(Dependency v) => v.version;
  static const Field<Dependency, Version> _f$version = Field(
    'version',
    _$version,
    opt: true,
    hook: VersionHook(),
...
mixin VersionObjectMappable {
  String toJson() {
    return VersionObjectMapper.ensureInitialized().encodeJson<VersionObject>(
      this as VersionObject,
    );
  }

  Map<String, dynamic> toMap() {
    return VersionObjectMapper.ensureInitialized().encodeMap<VersionObject>(
      this as VersionObject,
    );
  }
  ...
  get copyWith =>
      _VersionObjectCopyWithImpl(this as VersionObject, $identity, $identity);
  @override
  String toString() {
    return VersionObjectMapper.ensureInitialized().stringifyValue(
      this as VersionObject,
    );
  }
  ...
  @override
  bool operator ==(Object other) {
    return VersionObjectMapper.ensureInitialized().equalsValue(
      this as VersionObject,
      other,
    );
  }
  ...
  @override
  int get hashCode {
    return VersionObjectMapper.ensureInitialized().hashValue(
      this as VersionObject,
    );
  }
}
