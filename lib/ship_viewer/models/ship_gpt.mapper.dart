...
class ShipMapper extends ClassMapperBase<Ship> {
  ...
  static const Field<Ship, String> _f$designation = Field(
    'designation',
    _$designation,
    opt: true,
  );
  ...
  static const Field<Ship, String> _f$systemId = Field(
    'systemId',
    _$systemId,
    key: r'system id',
    opt: true,
  ...
  static const Field<Ship, double> _f$fleetPts = Field(
    'fleetPts',
    _$fleetPts,
    key: r'fleet pts',
    opt: true,
  ...
  static const Field<Ship, double> _f$hitpoints = Field(
    'hitpoints',
    _$hitpoints,
    opt: true,
  );
  static double? _$armorRating(Ship v) => v.armorRating;
  static const Field<Ship, double> _f$armorRating = Field(
    'armorRating',
    _$armorRating,
    key: r'armor rating',
    opt: true,
  ...
  static const Field<Ship, double> _f$maxFlux = Field(
    'maxFlux',
    _$maxFlux,
    key: r'max flux',
    opt: true,
  ...
  static const Field<Ship, double> _f$ordnancePoints = Field(
    'ordnancePoints',
    _$ordnancePoints,
    key: r'ordnance points',
    opt: true,
  );
  static double? _$fighterBays(Ship v) => v.fighterBays;
  static const Field<Ship, double> _f$fighterBays = Field(
    'fighterBays',
    _$fighterBays,
    key: r'fighter bays',
    opt: true,
  ...
  static const Field<Ship, double> _f$maxSpeed = Field(
    'maxSpeed',
    _$maxSpeed,
    key: r'max speed',
    opt: true,
  ...
  static const Field<Ship, double> _f$acceleration = Field(
    'acceleration',
    _$acceleration,
    opt: true,
  );
  static double? _$deceleration(Ship v) => v.deceleration;
  static const Field<Ship, double> _f$deceleration = Field(
    'deceleration',
    _$deceleration,
    opt: true,
  );
  static double? _$maxTurnRate(Ship v) => v.maxTurnRate;
  static const Field<Ship, double> _f$maxTurnRate = Field(
    'maxTurnRate',
    _$maxTurnRate,
    key: r'max turn rate',
    opt: true,
  ...
  static const Field<Ship, String> _f$shieldType = Field(
    'shieldType',
    _$shieldType,
    key: r'shield type',
    opt: true,
  ...
  static const Field<Ship, String> _f$defenseId = Field(
    'defenseId',
    _$defenseId,
    key: r'defense id',
    opt: true,
  ...
  static const Field<Ship, double> _f$shieldArc = Field(
    'shieldArc',
    _$shieldArc,
    key: r'shield arc',
    opt: true,
  ...
  static const Field<Ship, double> _f$shieldUpkeep = Field(
    'shieldUpkeep',
    _$shieldUpkeep,
    key: r'shield upkeep',
    opt: true,
  ...
  static const Field<Ship, double> _f$shieldEfficiency = Field(
    'shieldEfficiency',
    _$shieldEfficiency,
    key: r'shield efficiency',
    opt: true,
  );
  static double? _$phaseCost(Ship v) => v.phaseCost;
  static const Field<Ship, double> _f$phaseCost = Field(
    'phaseCost',
    _$phaseCost,
    key: r'phase cost',
    opt: true,
  ...
  static const Field<Ship, double> _f$phaseUpkeep = Field(
    'phaseUpkeep',
    _$phaseUpkeep,
    key: r'phase upkeep',
    opt: true,
  ...
  static const Field<Ship, double> _f$minCrew = Field(
    'minCrew',
    _$minCrew,
    key: r'min crew',
    opt: true,
  ...
  static const Field<Ship, double> _f$maxCrew = Field(
    'maxCrew',
    _$maxCrew,
    key: r'max crew',
    opt: true,
  ...
  static const Field<Ship, double> _f$cargo = Field(
    'cargo',
    _$cargo,
    opt: true,
  );
  ...
  static const Field<Ship, double> _f$fuelPerLY = Field(
    'fuelPerLY',
    _$fuelPerLY,
    key: r'fuel/ly',
    opt: true,
  ...
  static const Field<Ship, double> _f$range = Field(
    'range',
    _$range,
    opt: true,
  );
  static double? _$maxBurn(Ship v) => v.maxBurn;
  static const Field<Ship, double> _f$maxBurn = Field(
    'maxBurn',
    _$maxBurn,
    key: r'max burn',
    opt: true,
  ...
  static const Field<Ship, double> _f$baseValue = Field(
    'baseValue',
    _$baseValue,
    key: r'base value',
    opt: true,
  ...
  static const Field<Ship, double> _f$crPercentPerDay = Field(
    'crPercentPerDay',
    _$crPercentPerDay,
    key: r'cr %/day',
    opt: true,
  ...
  static const Field<Ship, double> _f$crToDeploy = Field(
    'crToDeploy',
    _$crToDeploy,
    key: r'cr to deploy',
    opt: true,
  ...
  static const Field<Ship, double> _f$peakCrSec = Field(
    'peakCrSec',
    _$peakCrSec,
    key: r'peak cr sec',
    opt: true,
  ...
  static const Field<Ship, double> _f$crLossPerSec = Field(
    'crLossPerSec',
    _$crLossPerSec,
    key: r'cr loss/sec',
    opt: true,
  ...
  static const Field<Ship, double> _f$suppliesRec = Field(
    'suppliesRec',
    _$suppliesRec,
    key: r'supplies/rec',
    opt: true,
  ...
  static const Field<Ship, double> _f$suppliesMo = Field(
    'suppliesMo',
    _$suppliesMo,
    key: r'supplies/mo',
    opt: true,
  ...
  static const Field<Ship, List<String>> _f$hints = Field(
    'hints',
    _$hints,
    opt: true,
    hook: StringArrayHook(),
  );
  static List<String>? _$tags(Ship v) => v.tags;
  static const Field<Ship, List<String>> _f$tags = Field(
    'tags',
    _$tags,
    opt: true,
    hook: StringArrayHook(),
  ...
  static const Field<Ship, String> _f$rarity = Field(
    'rarity',
    _$rarity,
    opt: true,
  );
  ...
  static const Field<Ship, List<double>> _f$center = Field(
    'center',
    _$center,
    opt: true,
  );
  ...
  static const Field<Ship, double> _f$height = Field(
    'height',
    _$height,
    opt: true,
  );
  static double? _$width(Ship v) => v.width;
  static const Field<Ship, double> _f$width = Field(
    'width',
    _$width,
    opt: true,
  );
...
class _ShipCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Ship, $Out>
  ...
  Ship $make(CopyWithData data) => Ship(
    ...
    turnAcceleration: data.get(#turnAcceleration, or: $value.turnAcceleration),
