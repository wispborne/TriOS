      ...
      child: SingleChildScrollView(
        ...
        child: CustomSingleChildLayout(
          ...
          child: ListView.builder(
            ...
            // If any rows have a custom height, we need to disable itemExtent to allow the rows to be different heights.
            // This has a performance penalty, so we only do it when necessary.
            itemExtent: _rows.any((row) => row.height != null)
                ? null
            ...
            itemBuilder: (ctx, i) {
              ...
              return stateManager.rowWrapper != null ? stateManager.rowWrapper(w) : w;
            },
          ),
        ),
      ),
