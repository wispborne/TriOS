...
class GraphicsLibLunaConfigMapper
  ...
  static const Field<GraphicsLibLunaConfig, bool> _f$aaCompatMode =
      Field('aaCompatMode', _$aaCompatMode, opt: true, def: false);
  static bool _$autoGenNormals(GraphicsLibLunaConfig v) => v.autoGenNormals;
  static const Field<GraphicsLibLunaConfig, bool> _f$autoGenNormals =
      Field('autoGenNormals', _$autoGenNormals, opt: true, def: true);
  static bool _$enableNormal(GraphicsLibLunaConfig v) => v.enableNormal;
  static const Field<GraphicsLibLunaConfig, bool> _f$enableNormal =
      Field('enableNormal', _$enableNormal, opt: true, def: true);
  static bool _$enableShaders(GraphicsLibLunaConfig v) => v.enableShaders;
  static const Field<GraphicsLibLunaConfig, bool> _f$enableShaders =
      Field('enableShaders', _$enableShaders, opt: true, def: true);
  static bool _$loadMaterial(GraphicsLibLunaConfig v) => v.loadMaterial;
  static const Field<GraphicsLibLunaConfig, bool> _f$loadMaterial =
      Field('loadMaterial', _$loadMaterial, opt: true, def: true);
  static bool _$loadSurface(GraphicsLibLunaConfig v) => v.loadSurface;
  static const Field<GraphicsLibLunaConfig, bool> _f$loadSurface =
      Field('loadSurface', _$loadSurface, opt: true, def: true);
  static bool _$optimizeNormals(GraphicsLibLunaConfig v) => v.optimizeNormals;
  static const Field<GraphicsLibLunaConfig, bool> _f$optimizeNormals =
      Field('optimizeNormals', _$optimizeNormals, opt: true, def: false);
  static bool _$preloadAllMaps(GraphicsLibLunaConfig v) => v.preloadAllMaps;
  static const Field<GraphicsLibLunaConfig, bool> _f$preloadAllMaps =
      Field('preloadAllMaps', _$preloadAllMaps, opt: true, def: false);
...
mixin GraphicsLibLunaConfigMappable {
  ...
  GraphicsLibLunaConfigCopyWith<GraphicsLibLunaConfig, GraphicsLibLunaConfig,
      GraphicsLibLunaConfig> get copyWith => _GraphicsLibLunaConfigCopyWithImpl<
          GraphicsLibLunaConfig, GraphicsLibLunaConfig>(
      this as GraphicsLibLunaConfig, $identity, $identity);
  @override
  String toString() {
    return GraphicsLibLunaConfigMapper.ensureInitialized()
        .stringifyValue(this as GraphicsLibLunaConfig);
  }

  @override
  bool operator ==(Object other) {
    return GraphicsLibLunaConfigMapper.ensureInitialized()
        .equalsValue(this as GraphicsLibLunaConfig, other);
  }

  @override
  int get hashCode {
    return GraphicsLibLunaConfigMapper.ensureInitialized()
        .hashValue(this as GraphicsLibLunaConfig);
  }
}
