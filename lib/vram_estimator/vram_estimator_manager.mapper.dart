...
class VramEstimatorManagerStateMapper
  ...
  static VramEstimatorManagerStateMapper ensureInitialized() {
    if (_instance == null) {
      MapperContainer.globals
          .use(_instance = VramEstimatorManagerStateMapper._());
  ...
  static const Field<VramEstimatorManagerState, bool> _f$isScanning =
      Field('isScanning', _$isScanning, mode: FieldMode.member);
  static bool _$isCancelled(VramEstimatorManagerState v) => v.isCancelled;
  static const Field<VramEstimatorManagerState, bool> _f$isCancelled =
...
mixin VramEstimatorManagerStateMappable {
  ...
  VramEstimatorManagerStateCopyWith<VramEstimatorManagerState,
          VramEstimatorManagerState, VramEstimatorManagerState>
      get copyWith => _VramEstimatorManagerStateCopyWithImpl<
              VramEstimatorManagerState, VramEstimatorManagerState>(
          this as VramEstimatorManagerState, $identity, $identity);
  @override
  String toString() {
    return VramEstimatorManagerStateMapper.ensureInitialized()
        .stringifyValue(this as VramEstimatorManagerState);
  }

  @override
  bool operator ==(Object other) {
    return VramEstimatorManagerStateMapper.ensureInitialized()
        .equalsValue(this as VramEstimatorManagerState, other);
  }

  @override
  int get hashCode {
    return VramEstimatorManagerStateMapper.ensureInitialized()
        .hashValue(this as VramEstimatorManagerState);
  }
}
...
extension VramEstimatorManagerStateValueCopy<$R, $Out>
  ...
  VramEstimatorManagerStateCopyWith<$R, VramEstimatorManagerState, $Out>
      get $asVramEstimatorManagerState => $base.as((v, t, t2) =>
          _VramEstimatorManagerStateCopyWithImpl<$R, $Out>(v, t, t2));
}
