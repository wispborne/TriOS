...
class WeaponMapper extends ClassMapperBase<Weapon> {
  ...
  static const Field<Weapon, double> _f$rarity =
  ...
  static const Field<Weapon, double> _f$impact =
  ...
  static const Field<Weapon, double> _f$chargedown =
  ...
  static const Field<Weapon, String> _f$extraArcForAI =
      Field('extraArcForAI', _$extraArcForAI, opt: true);
  static String? _$hints(Weapon v) => v.hints;
  static const Field<Weapon, String> _f$hints =
      Field('hints', _$hints, opt: true);
  ...
  static const Field<Weapon, String> _f$groupTag =
      Field('groupTag', _$groupTag, opt: true);
  ...
  static const Field<Weapon, String> _f$speedStr =
      Field('speedStr', _$speedStr, opt: true);
  static String? _$trackingStr(Weapon v) => v.trackingStr;
  static const Field<Weapon, String> _f$trackingStr =
      Field('trackingStr', _$trackingStr, opt: true);
  static String? _$turnRateStr(Weapon v) => v.turnRateStr;
  static const Field<Weapon, String> _f$turnRateStr =
      Field('turnRateStr', _$turnRateStr, opt: true);
  static String? _$accuracyStr(Weapon v) => v.accuracyStr;
  static const Field<Weapon, String> _f$accuracyStr =
      Field('accuracyStr', _$accuracyStr, opt: true);
  static String? _$customPrimary(Weapon v) => v.customPrimary;
  static const Field<Weapon, String> _f$customPrimary =
      Field('customPrimary', _$customPrimary, opt: true);
  static String? _$customPrimaryHL(Weapon v) => v.customPrimaryHL;
  static const Field<Weapon, String> _f$customPrimaryHL =
      Field('customPrimaryHL', _$customPrimaryHL, opt: true);
  static String? _$customAncillary(Weapon v) => v.customAncillary;
  static const Field<Weapon, String> _f$customAncillary =
      Field('customAncillary', _$customAncillary, opt: true);
  static String? _$customAncillaryHL(Weapon v) => v.customAncillaryHL;
  static const Field<Weapon, String> _f$customAncillaryHL =
      Field('customAncillaryHL', _$customAncillaryHL, opt: true);
  static bool? _$noDPSInTooltip(Weapon v) => v.noDPSInTooltip;
  static const Field<Weapon, bool> _f$noDPSInTooltip =
      Field('noDPSInTooltip', _$noDPSInTooltip, opt: true);
  static double? _$number(Weapon v) => v.number;
  static const Field<Weapon, double> _f$number =
      Field('number', _$number, opt: true);
  static String? _$specClass(Weapon v) => v.specClass;
  static const Field<Weapon, String> _f$specClass =
  ...
  static const Field<Weapon, String> _f$turretSprite =
      Field('turretSprite', _$turretSprite, opt: true);
  static String? _$turretGunSprite(Weapon v) => v.turretGunSprite;
  static const Field<Weapon, String> _f$turretGunSprite =
      Field('turretGunSprite', _$turretGunSprite, opt: true);
  static String? _$hardpointSprite(Weapon v) => v.hardpointSprite;
  static const Field<Weapon, String> _f$hardpointSprite =
      Field('hardpointSprite', _$hardpointSprite, opt: true);
  static String? _$hardpointGunSprite(Weapon v) => v.hardpointGunSprite;
  static const Field<Weapon, String> _f$hardpointGunSprite =
      Field('hardpointGunSprite', _$hardpointGunSprite, opt: true);
...
class _WeaponCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, Weapon, $Out>
  ...
  Weapon $make(CopyWithData data) => Weapon(
      ...
      spreadDecayPerSec:
          data.get(#spreadDecayPerSec, or: $value.spreadDecayPerSec),
      ...
      autofireAccBonus:
          data.get(#autofireAccBonus, or: $value.autofireAccBonus),
      ...
      forWeaponTooltip:
          data.get(#forWeaponTooltip, or: $value.forWeaponTooltip),
      ...
      customAncillaryHL:
          data.get(#customAncillaryHL, or: $value.customAncillaryHL),
      ...
      hardpointGunSprite:
          data.get(#hardpointGunSprite, or: $value.hardpointGunSprite));
