...
class WeaponsPageStateMapper extends ClassMapperBase<WeaponsPageState> {
  ...
  static const Field<WeaponsPageState, List<Weapon>> _f$allWeapons =
      Field('allWeapons', _$allWeapons, opt: true, def: const []);
  static List<Weapon> _$filteredWeapons(WeaponsPageState v) =>
      v.filteredWeapons;
  static const Field<WeaponsPageState, List<Weapon>> _f$filteredWeapons =
      Field('filteredWeapons', _$filteredWeapons, opt: true, def: const []);
  ...
  static const Field<WeaponsPageState, List<Weapon>>
      _f$weaponsBeforeGridFilter = Field(
          'weaponsBeforeGridFilter', _$weaponsBeforeGridFilter,
          opt: true, def: const []);
  ...
  static const Field<WeaponsPageState, WeaponSpoilerLevel>
      _f$weaponSpoilerLevel = Field('weaponSpoilerLevel', _$weaponSpoilerLevel,
          opt: true, def: WeaponSpoilerLevel.noSpoilers);
  ...
  WeaponsPageStateCopyWith<WeaponsPageState, WeaponsPageState, WeaponsPageState>
      get copyWith =>
          _WeaponsPageStateCopyWithImpl<WeaponsPageState, WeaponsPageState>(
              this as WeaponsPageState, $identity, $identity);
  @override
  String toString() {
    return WeaponsPageStateMapper.ensureInitialized()
        .stringifyValue(this as WeaponsPageState);
  }

  @override
  bool operator ==(Object other) {
    return WeaponsPageStateMapper.ensureInitialized()
        .equalsValue(this as WeaponsPageState, other);
  }

  @override
  int get hashCode {
    return WeaponsPageStateMapper.ensureInitialized()
        .hashValue(this as WeaponsPageState);
  }
}
...
extension WeaponsPageStateValueCopy<$R, $Out>
  ...
  WeaponsPageStateCopyWith<$R, WeaponsPageState, $Out>
      get $asWeaponsPageState => $base
          .as((v, t, t2) => _WeaponsPageStateCopyWithImpl<$R, $Out>(v, t, t2));
}

abstract class WeaponsPageStateCopyWith<$R, $In extends WeaponsPageState, $Out>
    implements ClassCopyWith<$R, $In, $Out> {
  ListCopyWith<$R, GridFilter<Weapon>,
  ...
  MapCopyWith<$R, String, List<String>,
      ObjectCopyWith<$R, List<String>, List<String>>> get weaponSearchIndices;
  $R call(
...
class _WeaponsPageStateCopyWithImpl<$R, $Out>
  ...
  @override
  ListCopyWith<$R, Weapon, WeaponCopyWith<$R, Weapon, Weapon>> get allWeapons =>
      ListCopyWith($value.allWeapons, (v, t) => v.copyWith.$chain(t),
          (v) => call(allWeapons: v));
  @override
  ListCopyWith<$R, Weapon, WeaponCopyWith<$R, Weapon, Weapon>>
      get filteredWeapons => ListCopyWith($value.filteredWeapons,
          (v, t) => v.copyWith.$chain(t), (v) => call(filteredWeapons: v));
  @override
  ListCopyWith<$R, Weapon, WeaponCopyWith<$R, Weapon, Weapon>>
  ...
  WeaponsPageState $make(CopyWithData data) => WeaponsPageState(
      ...
      weaponsBeforeGridFilter: data.get(#weaponsBeforeGridFilter,
          or: $value.weaponsBeforeGridFilter),
      weaponSearchIndices:
          data.get(#weaponSearchIndices, or: $value.weaponSearchIndices),
      currentSearchQuery:
      ...
      weaponSpoilerLevel:
          data.get(#weaponSpoilerLevel, or: $value.weaponSpoilerLevel));
