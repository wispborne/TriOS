...
class GamePathsSetupStateMapper extends ClassMapperBase<GamePathsSetupState> {
  ...
  static const Field<GamePathsSetupState, CustomPathFieldState>
      _f$customExecutablePathState = Field(
          'customExecutablePathState', _$customExecutablePathState,
          opt: true, def: const CustomPathFieldState());
  static CustomPathFieldState _$customModsPathState(GamePathsSetupState v) =>
      v.customModsPathState;
  static const Field<GamePathsSetupState, CustomPathFieldState>
      _f$customModsPathState = Field(
          'customModsPathState', _$customModsPathState,
          opt: true, def: const CustomPathFieldState());
...
class _GamePathsSetupStateCopyWithImpl<$R, $Out>
  ...
  @override
  CustomPathFieldStateCopyWith<$R, CustomPathFieldState, CustomPathFieldState>
      get customModsPathState => $value.customModsPathState.copyWith
          .$chain((v) => call(customModsPathState: v));
  @override
  CustomPathFieldStateCopyWith<$R, CustomPathFieldState, CustomPathFieldState>
      get customSavesPathState => $value.customSavesPathState.copyWith
          .$chain((v) => call(customSavesPathState: v));
  @override
  CustomPathFieldStateCopyWith<$R, CustomPathFieldState, CustomPathFieldState>
      get customCorePathState => $value.customCorePathState.copyWith
          .$chain((v) => call(customCorePathState: v));
  @override
  $R call(
          {String? gamePathText,
          bool? gamePathExists,
  ...
  GamePathsSetupState $make(CopyWithData data) => GamePathsSetupState(
      ...
      customExecutablePathState: data.get(#customExecutablePathState,
          or: $value.customExecutablePathState),
      customModsPathState:
          data.get(#customModsPathState, or: $value.customModsPathState),
      customSavesPathState:
          data.get(#customSavesPathState, or: $value.customSavesPathState),
      customCorePathState:
          data.get(#customCorePathState, or: $value.customCorePathState));
...
class CustomPathFieldStateMapper extends ClassMapperBase<CustomPathFieldState> {
  ...
  static const Field<CustomPathFieldState, bool> _f$useCustomPath =
      Field('useCustomPath', _$useCustomPath, opt: true, def: false);
  static String _$pathText(CustomPathFieldState v) => v.pathText;
  static const Field<CustomPathFieldState, String> _f$pathText =
      Field('pathText', _$pathText, opt: true, def: '');
  static bool _$pathExists(CustomPathFieldState v) => v.pathExists;
  static const Field<CustomPathFieldState, bool> _f$pathExists =
      Field('pathExists', _$pathExists, opt: true, def: false);
...
mixin CustomPathFieldStateMappable {
  ...
  CustomPathFieldStateCopyWith<CustomPathFieldState, CustomPathFieldState,
      CustomPathFieldState> get copyWith => _CustomPathFieldStateCopyWithImpl<
          CustomPathFieldState, CustomPathFieldState>(
      this as CustomPathFieldState, $identity, $identity);
  @override
  String toString() {
    return CustomPathFieldStateMapper.ensureInitialized()
        .stringifyValue(this as CustomPathFieldState);
  }

  @override
  bool operator ==(Object other) {
    return CustomPathFieldStateMapper.ensureInitialized()
        .equalsValue(this as CustomPathFieldState, other);
  }

  @override
  int get hashCode {
    return CustomPathFieldStateMapper.ensureInitialized()
        .hashValue(this as CustomPathFieldState);
  }
}
