    ...
    return Column(
      ...
      children: [
        ...
        CustomPathField(
          ...
          initialPath: state.customExecutablePathState.pathText,
          isChecked: settings.useCustomGameExePath,
        ...
        CustomPathField(
          ...
          initialPath: state.customModsPathState.pathText,
        ...
        CustomPathField(
          ...
          initialPath: state.customSavesPathState.pathText,
        ...
        CustomPathField(
          ...
          initialPath: state.customCorePathState.pathText,
