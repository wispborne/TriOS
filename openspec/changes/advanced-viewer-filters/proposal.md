...
Add an Advanced mode toggle to the existing filter panel. When on, it shows
per-group logic controls and numeric range filters. When off, the panel looks
and works exactly as it does today — no learning curve for casual use.
