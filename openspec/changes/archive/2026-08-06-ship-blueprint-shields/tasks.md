...
- [x] Verify by eye against the game: Medusa (blue, 300° front), a low-tech ship (red fill), a fighter (thin ring), a 360° shield; check animation toggle freezes it and unfocusing the window pauses it.
...
- [x] Verify by eye against the game: shields look right, and the shown-layer toggles + animate toggle come back after a restart and are shared between the ship details dialog and the codex view.
