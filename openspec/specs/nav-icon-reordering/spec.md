# nav-icon-reordering Specification

## Purpose

Defines user-customizable ordering of main navigation icons shared across the sidebar and top-bar layouts, including drag-mode interaction, pinned items, divider handling, persistence, and reconciliation behavior.
